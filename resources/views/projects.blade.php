                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <button class="dropdown-item small" data-bs-toggle="modal" data-bs-target="#editProjectModal" data-id="1" data-name="Ребрендинг сайта" data-desc="Обновление дизайна и фронтенда">
                                        <i class="bi bi-pencil me-2 text-muted"></i>Редактировать
                                    </button>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <form action="#" method="POST" onsubmit="return confirm('Удалить проект? Все задачи останутся без проекта.')">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-1 small text-muted">
                            ...
                            @php
                                $tasks = \App\Models\Task::with(['project_id' => $project->id]);
                    ...
                    <div class="d-flex justify-content-between align-items-center text-muted small border-top pt-2">
                        ...
                        <span class="badge bg-light text-dark border">В работе: {{$tasks->where(['status' => 'in_progress'])->count()}}</span>
                    </div>
                </div>
                <div class="card-footer bg-white border-0 pt-0 pb-3 px-3">
                    <a href="{{route('index', $project)}}" class="btn btn-sm btn-outline-primary w-100">Открыть задачи проекта</a>
                </div>
            </div>
        </div>
        @endforeach
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu p-2 w-100" aria-labelledby="userDropdown">
                            ...
                            <div id="manager_id" style="max-height: 200px; overflow-y: auto;">
                                ...
                                <button class="dropdown-item small" type="button" data-value="{{$user->id}}">{{$user->name}}</button>
                                @endforeach
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="#" method="POST" id="editProjectForm">
                    ...
                    <div class="modal-body row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label">Описание</label>
                            <textarea name="description" id="edit_project_description" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Отмена</button>
