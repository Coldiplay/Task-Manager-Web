        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <h2 class="card-title h3 mb-3">Разработать API авторизации</h2>
                    <p class="text-secondary">Необходимо спроектировать и реализовать REST API для регистрации и авторизации пользователей с использованием JWT токенов. Написать тесты.</p>
                </div>
            </div>
