            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <h5 class="card-title text-dark mb-0">название проекта</h5>
                        <!-- Действия CRUD -->
                        <div class="dropdown">
                    ...
                    <div class="d-flex justify-content-between align-items-center text-muted small border-top pt-2">
                        <span><i class="bi bi-list-task me-1"></i> 10 задач</span>
                        <span class="badge bg-light text-dark border">В работе: 4</span>
                    </div>
                </div>
                <div class="card-footer bg-white border-0 pt-0 pb-3 px-3">
                    <a href="#" class="btn btn-sm btn-outline-primary w-100">Открыть задачи проекта</a>
                </div>
            </div>
        </div>
    </div>
